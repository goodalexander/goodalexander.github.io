...
.pm-fig-cap li:last-child { margin-bottom: 0; }
.pm-fig-cap li::before {
  content: "·";
  position: absolute;
  left: 0;
  color: var(--gold);
...
<figure class="pm-fig" id="fig-neuromatrix">
  ...
  <ul class="pm-fig-cap">
    <li>Pain is generated by a distributed brain network — not read directly off tissue damage.</li>
    <li>Each extra input (appraisal, memory, identity, context) adds another distinguishable suffering state.</li>
    <li>You are built to manufacture pain from sparse somatic cues.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-iasp">
  ...
  <ul class="pm-fig-cap">
    <li>IASP definition: pain is always sensory <em>and</em> emotional — never one without the other.</li>
    <li>Two mandatory dimensions means the state-space multiplies, not collapses.</li>
    <li>Clinical medicine has no concept of pure nociception without distress.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-icd11">
  ...
  <ul class="pm-fig-cap">
    <li>Official medicine already sorts chronic pain into seven top-level diagnoses, each with nested subtypes.</li>
    <li>Mechanism, body site, and psychosocial context are treated as independent axes — not redundant labels.</li>
    <li>The taxonomy assumes suffering enumerates faster than it collapses.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-mcgill">
  ...
  <ul class="pm-fig-cap">
    <li>Clinicians need 78 words to describe pain; nobody needs 78 words to describe pleasure.</li>
    <li>Ordinary language already splits pain into sensory, affective, evaluative, and mixed domains.</li>
    <li>Language inventories suffering first — the pain machine came with a built-in thesaurus.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-price">
  ...
  <ul class="pm-fig-cap">
    <li>Three separable layers: sensation → unpleasantness → secondary affect — not one fungible signal.</li>
    <li>Opioids damp one layer; they don't fold grief, shame, or injustice into a single receptor hit.</li>
    <li>Pain stays multidimensional where engineered bliss collapses to a drug class.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-berridge">
  ...
  <ul class="pm-fig-cap">
    <li>Real pleasure causation concentrates in ~3 hedonic hotspots — a tiny hardware footprint.</li>
    <li>Food, sex, music, and achievement collapse to ~4 receptor classes a pill can hijack.</li>
    <li>You are not built to enumerate bliss; you are built to compress it.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-leknes">
  ...
  <ul class="pm-fig-cap">
    <li>Pain and reward share opioid/dopamine circuitry — which is why fentanyl can substitute for joy.</li>
    <li>That overlap compresses pleasure; it does not collapse grief, shame, or social suffering.</li>
    <li>Comfort has a small pharmacological floor. Suffering does not.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-baumeister">
  ...
  <ul class="pm-fig-cap">
    <li>Negative events outweigh positive ones across trauma, relationships, learning, and self-concept.</li>
    <li>The brain processes bad news more deeply than good news — almost without exception.</li>
    <li>Firmware bias: register harm first, discount delight.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-rozin">
  ...
  <ul class="pm-fig-cap">
    <li>Negative states are more varied and finely distinguished than positive ones.</li>
    <li>More words, more circuits, more behavioral responses for suffering than for comfort.</li>
    <li>Evolution optimized threat enumeration — not bliss enumeration.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-eisenberger">
  ...
  <ul class="pm-fig-cap">
    <li>Social rejection activates the pain matrix with no peripheral nociception — ostracism hurts literally.</li>
    <li>Another entire domain of suffering, with no parallel expansion for comfort.</li>
    <li>The pain machine extends into psychology; the pleasure machine does not.</li>
  </ul>
</figure>
...
<figure class="pm-fig" id="fig-lazarus">
  ...
  <ul class="pm-fig-cap">
    <li>Same injury, different frame → different suffering: injustice, fate, or self-blame are not interchangeable.</li>
    <li>Appraisal is an independent axis — grief won't collapse under analgesia the way bliss collapses under fentanyl.</li>
    <li>Your spec multiplies pain by meaning; it does not multiply pleasure the same way.</li>
  </ul>
</figure>

</div>

<p class="pm-bridge">The pharmacological catalog is small (~11 receptor classes). The pain descriptor catalog is not (78 words, seven ICD categories, eight model axes). Section II counts the product.</p>
