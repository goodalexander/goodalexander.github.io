...
<figure class="pm-fig" id="fig-neuromatrix">
  ...
  <div class="pm-arg" role="group" aria-label="Argument: neuromatrix">
    ...
    <div class="pm-arg-cell impact"><span class="pm-arg-label">Impact</span><p>Appraisal, memory, identity, and context each multiply pain cardinality; pleasure has no parallel distributed generator. Sparse somatic input → vast suffering-space — the pain-machine ratio starts here.</p></div>
  </div>
</figure>
